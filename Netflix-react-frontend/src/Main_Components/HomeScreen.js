...
//Row
    ...
    var handlefilter=(e)=>{
      ...
      var newFilter=NetflixOriginals.filter((value)=>{
        return value.name.toLowerCase().includes(searchWord.toLowerCase()) || value.original_name.toLowerCase().includes(searchWord.toLowerCase());   
      })
      ...
      <div className={`nav ${show &&'nav_black'}`}>
        <div className='nav_contents'>
          ...
          <div className='search-contents'>
              {search &&
                <div>
                      <input id='input' type="text" className='nav_searchbar' onClick={handlekeys}/>
                      <CloseIcon onClick={()=>{
                        setSearch(false);
                        setFilterdata([]);
          ...
          {!search && <SearchIcon onClick={()=>setSearch(true)} className='search-icon'/>}
          <img
